            ...
            <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
                ...
                <div class="bg-surface rounded-lg border border-default p-8 mb-8">
                    <div class="text-center py-12">
                        ...
                        <h3 class="text-xl font-medium text-gray-900 mb-2">Formular wird hier eingefügt</h3>
                        <p class="text-gray-500">
                            Hier werden später die Felder für Praxisinformationen, Kontaktdaten, 
                            Spezialisierung und grundlegende Einstellungen eingefügt.
                        </p>
                    </div>
                </div>
